...
BEGIN {
    ...
    __PACKAGE__->attributes( 'optional', [ 'member_of', 'import', 'mp_import', 'export', 'mp_export', 'default', 'mp_default', 'remarks', 'notify', 'mnt_lower', 'mnt_routes' ] );
    __PACKAGE__->attributes( 'single', [ 'aut_num', 'as_name', 'source' ] );
